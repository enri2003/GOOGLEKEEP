...
export class UsuarioController {
  ...
  // PUT /usuariocontroller/:id — reemplaza todos los campos del usuario
  @Put(':id')
  async updateFull(
  ...
  // PATCH /usuariocontroller/:id — actualiza solo los campos enviados
  @Patch(':id')
  async updatePartial(
    @Param('id', ParseIntPipe) id: number,
    @Body() data: UpdateUsuarioDto,
  ...
  // DELETE /usuariocontroller/:id — elimina un usuario
  @Delete(':id')
