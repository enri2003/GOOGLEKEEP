...
export class BestSellingWidget implements OnInit {
    ...
    ngOnInit(): void {
        ...
        // Considera si este endpoint es el correcto para este widget
        this.service.basePost(`notecontroller/getbyid/1`, {}).subscribe(
            response => console.log('Data loaded:', response),
